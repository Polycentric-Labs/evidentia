...
- Australia: Essential 8 (ISM uses the explicit offline corpus converter)
...
# The pinned complete ISM source is generated by refresh_open_corpora.py.
# This bulk legacy generator must not overwrite its package descriptor or
# reintroduce the retired 24 heading identifiers.
