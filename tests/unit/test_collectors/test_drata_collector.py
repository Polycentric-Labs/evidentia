...
def test_high_risk_detection_handles_extended_field_shapes_v0_7_13() -> None:
    ...
    variants = [
        _vendor_record(
            vendor_id="v-ext-severity",
            risk_level=None,
            extra={"severity": "high"},
        ),
        _vendor_record(
            vendor_id="v-ext-tier",
            risk_level=None,
            extra={"tier": "CRITICAL"},
        ),
        _vendor_record(
            vendor_id="v-ext-bare-risk",
            risk_level=None,
            extra={"risk": "Severe"},
        ),
        _vendor_record(
            vendor_id="v-ext-rating",
            risk_level=None,
            extra={"riskRating": "high"},
        ),
        _vendor_record(
            vendor_id="v-ext-class",
            risk_level=None,
            extra={"risk_class": "critical"},
        ),
        _vendor_record(
            vendor_id="v-ext-nested-rating",
            risk_level=None,
            extra={"riskAssessment": {"rating": "HIGH"}},
        ),
        _vendor_record(
            vendor_id="v-ext-summary-block",
            risk_level=None,
