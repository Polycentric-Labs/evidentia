"""Exercise the installed pagerduty adapter against indexed synthetic source bytes."""
...
from evidentia_collectors.incident_clock import pagerduty as adapter
...
PROVIDER = "pagerduty"
FILES = ["incident.json", "logs-page1.json", "logs-page2.json"]
