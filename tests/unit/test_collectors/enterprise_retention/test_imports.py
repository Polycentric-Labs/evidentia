...
assert not hasattr(package, "EnterpriseRetentionCollector")
...
if sys.argv[2] == "session":
    ...
    session = _client.EnterpriseReadSession(request, profile=_profiles.AuthorizedProfile(profile, Resolver()))
