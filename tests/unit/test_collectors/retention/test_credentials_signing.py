...
@pytest.mark.parametrize(
    "version",
    ["1.43.95", "1.43.93", "1.43.97", "1.44.0", "1.43.96+local", None],
...
def test_module_and_distribution_versions_must_agree(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(signing, "_package_version", lambda name: "1.43.96")
...
def test_missing_import_identity_is_preserved(name: str, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(signing, "_package_version", lambda package_name: "1.43.96")
