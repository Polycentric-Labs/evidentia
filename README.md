...
- **16 evidence collectors**: AWS, GitHub (including OSPS conformance helpers), Postgres, MySQL, Oracle, SQLite, MS-SQL, Snowflake, Databricks, Okta, Google Workspace, Entra ID / Microsoft 365, Vanta, Drata, BitSight and SecurityScorecard. Findings use OCSF-aligned compliance status; Entra/M365 also returns explicit capability completeness and source provenance.
