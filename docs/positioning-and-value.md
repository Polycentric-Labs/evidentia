...
- **OpenSSF published the Gemara model (March 2026)** — a layered reference architecture for GRC-engineering / compliance-as-code (Sonatype + Red Hat maintainers). It gives the "compliance-as-code" category a community-blessed structure; Evidentia should map its components onto Gemara's layers in positioning material (tracked in [integration-survey.md](integration-survey.md) §6)
