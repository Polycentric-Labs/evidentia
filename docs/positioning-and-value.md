...
- **Two regulatory forcing functions land in Q4 2026, on a stacked multi-year mandate runway** (re-based 2026-06-10; the prior "four in Q4 2026" framing predated the FedRAMP supersession): **CMMC Phase 2** (Level 2 C3PAO third-party assessments mandatory for the ~80K DOD contractors requiring Level 2 certification, of a ~220K-company DIB, **2026-11-10**) and **EU CRA reporting obligations** (24/72-hour incident + 14-day vulnerability reporting for any digital product placed on the EU market, **2026-09-11**). **Maryland MODPA** (strictest US privacy law, sale-of-sensitive-data prohibition) has been effective since **2025-10-01**, and the **FedRAMP machine-readable mandate** moved to **2027-11-01** for Class D (High) CSPs per NTC-0009 (2026-03-25), with FedRAMP Ready retiring 2026-07-28. HIPAA Security Rule final-rule target window: May 2026 (missed as of June 2026; still pending). Evidentia is positioned well ahead of where most commercial vendors deliver native OSCAL emit (see §8).
...
> ~80K DOD contractors requiring CMMC Level 2 certification (of a
> ~220K-company defense industrial base) who can't afford SaaS GRC.
...
> **Section summary (re-based 2026-06-10).** **Two regulatory
> forcing functions land in Q4 2026, on a stacked multi-year mandate
> runway** that explicitly favors OSCAL-native + SBOM-aware +
> cryptographic-evidence tools: **CMMC Phase 2** (Level 2 C3PAO
> third-party assessments mandatory for the ~80K DOD contractors
> requiring Level 2 certification, of a ~220K total DIB,
> **2026-11-10**); **EU CRA reporting obligations** (24/72-hour
> incident + 14-day vulnerability reporting for any digital product
> into EU, **2026-09-11**). **Maryland MODPA** (strictest US state
...
| 4 | **OSCAL adoption stalls** (e.g., FedRAMP 20x slows; CMMC delayed again) | Low-Medium | Medium | Diversify positioning across multiple tailwinds — **2 forcing functions in Q4 2026** (CMMC + CRA), MODPA already effective, the FedRAMP machine-readable mandate on the 2027-11-01 horizon; each can stand alone |
