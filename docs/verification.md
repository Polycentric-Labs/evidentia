...
pypi-attestations verify pypi \
  ...
  pypi:evidentia_core-0.11.2-py3-none-any.whl

# Expected output:
#   OK: evidentia_core-0.11.2-py3-none-any.whl
```
...
for pkg in evidentia evidentia_ai evidentia_api evidentia_collectors \
  ...
  pypi-attestations verify pypi \
    --repository https://github.com/Polycentric-Labs/evidentia \
    "pypi:${pkg}-0.11.2-py3-none-any.whl"
done
```
...
cosign verify ghcr.io/polycentric-labs/evidentia:v0.11.2 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.11.2" \
...
```bash
# Download the SBOM
gh release download v0.11.2 --pattern 'evidentia-sbom.cdx.json' \
...
> use the tool-native `gh attestation verify oci://ghcr.io/polycentric-labs/evidentia:v0.11.2 -R Polycentric-Labs/evidentia`
> instead (any `gh` version finds it).

**Bash / Linux / macOS**

```bash
cosign verify-attestation ghcr.io/polycentric-labs/evidentia:v0.11.2 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.11.2" \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
