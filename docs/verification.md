...
pypi-attestations verify pypi \
  ...
  pypi:evidentia_core-0.10.10-py3-none-any.whl

# Expected output:
#   OK: evidentia_core-0.10.10-py3-none-any.whl
```
...
for pkg in evidentia evidentia_ai evidentia_api evidentia_collectors \
  ...
  pypi-attestations verify pypi \
    --repository https://github.com/Polycentric-Labs/evidentia \
    "pypi:${pkg}-0.10.10-py3-none-any.whl"
done
```
...
cosign verify ghcr.io/polycentric-labs/evidentia:v0.10.10 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.10.10" \
...
```bash
# Download the SBOM
gh release download v0.10.10 --pattern 'evidentia-sbom.cdx.json' \
...
```bash
cosign verify-attestation ghcr.io/polycentric-labs/evidentia:v0.10.10 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.10.10" \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
