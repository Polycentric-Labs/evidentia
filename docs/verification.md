...
pypi-attestations verify pypi \
  ...
  pypi:evidentia_core-0.12.0-py3-none-any.whl

# Expected output:
#   OK: evidentia_core-0.12.0-py3-none-any.whl
```
...
for pkg in evidentia evidentia_ai evidentia_api evidentia_collectors \
  ...
  pypi-attestations verify pypi \
    --repository https://github.com/Polycentric-Labs/evidentia \
    "pypi:${pkg}-0.12.0-py3-none-any.whl"
done
```
...
cosign verify ghcr.io/polycentric-labs/evidentia:v0.12.0 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.12.0" \
...
```bash
# Download the SBOM
gh release download v0.12.0 --pattern 'evidentia-sbom.cdx.json' \
...
> use the tool-native `gh attestation verify oci://ghcr.io/polycentric-labs/evidentia:v0.12.0 -R Polycentric-Labs/evidentia`
> instead (any `gh` version finds it).

**Bash / Linux / macOS**

```bash
cosign verify-attestation ghcr.io/polycentric-labs/evidentia:v0.12.0 \
  --certificate-identity-regexp "https://github.com/Polycentric-Labs/evidentia/.github/workflows/release.yml@refs/tags/v0.12.0" \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
