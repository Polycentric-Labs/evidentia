...
```bash
docker pull ghcr.io/polycentric-labs/evidentia:v0.11.2
docker run --rm ghcr.io/polycentric-labs/evidentia:v0.11.2 version
# → Evidentia v0.11.2
# → Python 3.13.x
```
...
docker run --rm -v "$PWD:/work" -w /work \
  ghcr.io/polycentric-labs/evidentia:v0.11.2 \
