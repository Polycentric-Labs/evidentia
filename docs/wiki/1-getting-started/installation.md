...
```bash
docker pull ghcr.io/polycentric-labs/evidentia:v0.12.1
docker run --rm ghcr.io/polycentric-labs/evidentia:v0.12.1 version
# → Evidentia v0.12.1
# → Python 3.13.x
```
...
docker run --rm -v "$PWD:/work" -w /work \
  ghcr.io/polycentric-labs/evidentia:v0.12.1 \
