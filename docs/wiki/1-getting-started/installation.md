...
```bash
docker pull ghcr.io/polycentric-labs/evidentia:v0.10.12
docker run --rm ghcr.io/polycentric-labs/evidentia:v0.10.12 version
# → Evidentia v0.10.12
# → Python 3.12.x
```
...
docker run --rm -v "$PWD:/work" -w /work \
  ghcr.io/polycentric-labs/evidentia:v0.10.12 \
