<!-- AUTO-GENERATED MIRROR of docs/catalog-currency.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/catalog-currency.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/catalog-currency.md), the canonical source of truth. Do not edit this file directly; edit `docs/catalog-currency.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
Catalog content is a [non-frozen surface](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md). Import the version
