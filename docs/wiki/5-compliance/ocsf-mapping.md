<!-- AUTO-GENERATED MIRROR of docs/ocsf-mapping.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/ocsf-mapping.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ocsf-mapping.md), the canonical source of truth. Do not edit this file directly; edit `docs/ocsf-mapping.md` and re-run `scripts/wiki/sync_mirrors.py`.
