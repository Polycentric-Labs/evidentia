<!-- AUTO-GENERATED MIRROR of docs/contributing-a-catalog.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/contributing-a-catalog.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/contributing-a-catalog.md), the canonical source of truth. Do not edit this file directly; edit `docs/contributing-a-catalog.md` and re-run `scripts/wiki/sync_mirrors.py`.
