<!-- AUTO-GENERATED MIRROR of docs/financial-sector-overlay.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/financial-sector-overlay.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/financial-sector-overlay.md), the canonical source of truth. Do not edit this file directly; edit `docs/financial-sector-overlay.md` and re-run `scripts/wiki/sync_mirrors.py`.
