<!-- AUTO-GENERATED MIRROR of docs/gemara-mapping.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/gemara-mapping.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/gemara-mapping.md), the canonical source of truth. Do not edit this file directly; edit `docs/gemara-mapping.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
demand signal. See [`integration-survey.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/integration-survey.md)
...
- Evidentia surfaces named above are documented in
  [`api-stability.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md) §1 (frozen models),
  §2 (EventAction enum), §5 (library entry points).
- The OSCAL surface that overlaps with Gemara is documented in
  [`ocsf-mapping.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ocsf-mapping.md) (the OCSF interchange, which
  is itself one of Gemara's source ecosystems).
- The integration-survey context in
  [`integration-survey.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/integration-survey.md) ranks the
