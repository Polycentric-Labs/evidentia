...
Bundled catalogs are enumerated in one file: `catalogs/data/frameworks.yaml`. As of v0.11 it lists **96 frameworks**. The manifest's header makes the contract explicit:
