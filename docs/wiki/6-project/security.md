<!-- AUTO-GENERATED MIRROR of SECURITY.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`SECURITY.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/SECURITY.md), the canonical source of truth. Do not edit this file directly; edit `SECURITY.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
|---------|--------|--------|
| **`0.11.1`** | ✅ **Supported** | Latest patch. See the [CHANGELOG](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md) and the latest `docs/releases/reviews/security-review-*.md` for what shipped and the CVE posture at this release. |
