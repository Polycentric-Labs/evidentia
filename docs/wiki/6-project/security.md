<!-- AUTO-GENERATED MIRROR of .github/SECURITY.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`.github/SECURITY.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/SECURITY.md), the canonical source of truth. Do not edit this file directly; edit `.github/SECURITY.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
|---------|--------|--------|
| **`0.12.1`** | ✅ **Supported** | Latest patch. See the [CHANGELOG](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md) and the latest `docs/releases/reviews/security-review-*.md` for what shipped and the CVE posture at this release. |
...
- [`security-insights.yml`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/security-insights.yml) — OpenSSF Security
