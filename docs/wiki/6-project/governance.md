<!-- AUTO-GENERATED MIRROR of GOVERNANCE.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`GOVERNANCE.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/GOVERNANCE.md), the canonical source of truth. Do not edit this file directly; edit `GOVERNANCE.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
- **Code of Conduct enforcement** — see [`CODE_OF_CONDUCT.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CODE_OF_CONDUCT.md).
...
- **Technical decisions** — proposed and discussed in
  ...
  [`docs/`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs) as version-controlled records (e.g., the per-release
  plan files at `docs/v0.7.x-plan.md`).
- **Roadmap** — proposed and tracked in [`docs/ROADMAP.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ROADMAP.md)
...
Anyone can contribute. See [`CONTRIBUTING.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CONTRIBUTING.md) for
...
[`docs/access-continuity.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/access-continuity.md), which
...
- **Public process** — every operational procedure is documented
  ...
  [`threat-model.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/threat-model.md), security policy,
...
[`docs/access-continuity.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/access-continuity.md) for the
