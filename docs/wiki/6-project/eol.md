<!-- AUTO-GENERATED MIRROR of EOL.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`EOL.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/EOL.md), the canonical source of truth. Do not edit this file directly; edit `EOL.md` and re-run `scripts/wiki/sync_mirrors.py`.
