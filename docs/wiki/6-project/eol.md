<!-- AUTO-GENERATED MIRROR of docs/EOL.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/EOL.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/EOL.md), the canonical source of truth. Do not edit this file directly; edit `docs/EOL.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
- See [`SECURITY.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/SECURITY.md) Supported-versions table for current state.
...
Semantic Versioning 2.0.0 per [`README.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/README.md). Pre-1.0:
