<!-- AUTO-GENERATED MIRROR of CONTRIBUTING.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`CONTRIBUTING.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CONTRIBUTING.md), the canonical source of truth. Do not edit this file directly; edit `CONTRIBUTING.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
Please read [`CODE_OF_CONDUCT.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CODE_OF_CONDUCT.md) before participating.
