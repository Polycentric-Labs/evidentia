<!-- AUTO-GENERATED MIRROR of .github/CONTRIBUTING.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`.github/CONTRIBUTING.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/CONTRIBUTING.md), the canonical source of truth. Do not edit this file directly; edit `.github/CONTRIBUTING.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
Please read [`CODE_OF_CONDUCT.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/CODE_OF_CONDUCT.md) before participating.
...
3. **Phase 2 collectors.** AWS, GitHub, and Okta are the highest priority.
   ...
   [`Evidentia-Architecture-and-Implementation-Plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/architecture/Evidentia-Architecture-and-Implementation-Plan.md).
...
- **Python**: PEP 8 (style), PEP 257 (docstrings), PEP 484 / PEP 604 (type
  ...
  --strict` with the Pydantic plugin. Configuration: [`pyproject.toml`](https://github.com/Polycentric-Labs/evidentia/blob/main/pyproject.toml).
...
- **Pre-commit hooks** ([`.pre-commit-config.yaml`](https://github.com/Polycentric-Labs/evidentia/blob/main/.pre-commit-config.yaml))
...
project's own disclosure in [`docs/ai-assistance.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ai-assistance.md):
...
licensed under the [Apache License 2.0](https://github.com/Polycentric-Labs/evidentia/blob/main/LICENSE).
