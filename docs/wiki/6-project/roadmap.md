...
| Status | Meaning |
|---|---|
| `SHIPPED` | Released. A matching `## [X.Y.Z]` block exists in [`CHANGELOG.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md). |
| `PLANNED` | The single open cycle. Exactly one may exist, and its intro must link an on-disk plan under [`releases/plans/`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans). |
...
- **What shipped, and when**: [`CHANGELOG.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md) is authoritative
...
- **What the current cycle contains**: the top `PLANNED` section and its linked
  plan document.
- **What the v1.0 contract will freeze**: [`api-stability.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md)
  (NORMATIVE), with the open surface decisions in
  [`v1.0-freeze-candidates.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v1.0-freeze-candidates.md).
- **What v1.0 must satisfy to ship**: [`v1.0-transition.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v1.0-transition.md)
  holds the acceptance gates and the release narrative.
- **What is scheduled for removal**: [`deprecation-calendar.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/deprecation-calendar.md).
...
[`v0.12-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.12-plan.md). Every ratified scope
...
[`v1.0-freeze-candidates.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v1.0-freeze-candidates.md); (4) the FRR
...
- **KSI (Key Security Indicators) emission**: wires as third output
  ...
  record: [`v0.11-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.11-plan.md) §Wave 2.
