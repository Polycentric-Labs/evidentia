...
without scope loss — see [`docs/v0.10.5-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.10.5-plan.md)
...
- **All 11 remaining collectors populate `compliance_status`
  ...
  [`docs/v0.10.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.10.1-plan.md) §4 (gaps → FAIL,
...
- v0.10.1 pre-release-review opens one new finding: **F-V101-L1
  ...
  [`docs/v0.10.2-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.10.2-plan.md) Phase 3.
...
[`docs/v0.8.0-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.8.0-plan.md) (the OSS-native AI
...
- **`.github/actions/gap-analysis/action.yml`** — all four
  ...
  [`docs/v0.7.3-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.7.3-plan.md).
...
[`docs/v0.7.3-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.7.3-plan.md) for the next release
...
[`docs/v0.7.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.7.1-plan.md) **moved to**
...
to v0.7.2. See [`docs/v0.7.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.7.1-plan.md) (now
SHIPPED) for the line-item ship summary and
[`docs/v0.7.2-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v0.7.2-plan.md) for the forward plan.
