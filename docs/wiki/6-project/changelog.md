<!-- AUTO-GENERATED MIRROR of CHANGELOG.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`CHANGELOG.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md), the canonical source of truth. Do not edit this file directly; edit `CHANGELOG.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
- **Public registry evidence (V13-07 and V13-27).** `collect registry`, its API
  ...
  [registry design](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/designs/registry-collector-design.md). A mobile page
...
- **Enterprise retention configuration (V13-04).** `collect enterprise-retention`,
  ...
  See [the enterprise design](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/designs/enterprise-retention-collector-design.md).
- **Storage retention configuration (V13-04, storage milestone).** A new
  ...
  See [the storage collector design](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/designs/storage-retention-collector-design.md).
- **Entra ID and Microsoft 365 evidence (V13-02).** Nine bounded capabilities
  ...
  See [the collector design](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/designs/entra-m365-collector-design.md).
...
- **`evidentia_core.gap_store.GapReportRepository`** — an explicit-root
  ...
  provisional** — see
  [`v1.0-freeze-candidates.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v1.0-freeze-candidates.md) §4, which
...
Two accuracy corrections were caught by the documentation verify-everything pass and fixed in the canonical surfaces this cycle (full detail in [`docs/v0.10.7-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.10.7-plan.md) §12):
...
without scope loss — see [`docs/v0.10.5-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.10.5-plan.md)
§0/§0.A for the full plan-vs-actual reconciliation.

**Cross-links**: [`docs/positioning-and-value.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/positioning-and-value.md)
...
[`docs/v1.0-transition.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/v1.0-transition.md) §"Acceptance
gates for v1.0" (Gold honest-gap now tied to SOC 2 Type I
segregation-of-duties); [`docs/design-partner-program.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/design-partner-program.md)
v0 draft; [`docs/ocsf-mapping.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ocsf-mapping.md) §7.B
(Detection Finding emit); [`docs/collector-idempotency-audit.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/collector-idempotency-audit.md)
...
- **`Finding` class alias on `SecurityFinding`** (v0.10.1 rename):
  ...
  [`docs/deprecation-calendar.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/deprecation-calendar.md).
...
- **All 11 remaining collectors populate `compliance_status`
  ...
  [`docs/v0.10.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.10.1-plan.md) §4 (gaps → FAIL,
...
- v0.10.1 pre-release-review opens one new finding: **F-V101-L1
  ...
  [`docs/v0.10.2-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.10.2-plan.md) Phase 3.
...
- **OCSF Compliance Finding mapping layer (v0.10.0)**: new
  ...
  schema churn. See [`docs/ocsf-mapping.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ocsf-mapping.md).
...
- **NEW operator runbooks**:
  - [`docs/poam-runbook.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/poam-runbook.md) — end-
    to-end POA&M workflow (bootstrap → milestones →
    attention checks → close-out → OSCAL emit → audit-trail
    interpretation).
  - [`docs/conmon-runbook.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/conmon-runbook.md) —
...
[`docs/v0.8.0-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.8.0-plan.md) (the OSS-native AI
moat) + [`docs/sigstore-quickstart.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/sigstore-quickstart.md)
...
[`Evidentia-Architecture-and-Implementation-Plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/Evidentia-Architecture-and-Implementation-Plan.md)
...
- **`Dockerfile`** at repo root + **`.github/workflows/container-build.yml`**
  ...
  ([`docs/enterprise-grade.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/enterprise-grade.md))
...
- **`docs/v0.8.0-plan.md`** — forward-looking release plan for the
  ...
  [`positioning-and-value.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/positioning-and-value.md) §13.2
...
- **`.github/actions/gap-analysis/action.yml`** — all four
  ...
  [`docs/v0.7.3-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.7.3-plan.md).
...
[`docs/ide-setup.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/ide-setup.md) for the contributor-facing
IDE walkthrough.
...
[`docs/v0.7.3-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.7.3-plan.md) for the next release
...
[`docs/v0.7.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.7.1-plan.md) **moved to**
...
to v0.7.2. See [`docs/v0.7.1-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.7.1-plan.md) (now
SHIPPED) for the line-item ship summary and
[`docs/v0.7.2-plan.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/releases/plans/v0.7.2-plan.md) for the forward plan.
...
[`docs/enterprise-grade.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/enterprise-grade.md). Adds Sigstore/Rekor
...
See [`.github/actions/gap-analysis/README.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/.github/actions/gap-analysis/README.md)
...
See [RENAMED.md](https://github.com/Polycentric-Labs/evidentia/blob/main/RENAMED.md) for the full background.
