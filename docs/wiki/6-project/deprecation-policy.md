<!-- AUTO-GENERATED MIRROR of docs/deprecation-calendar.md -- do not edit directly -->
> **Auto-generated mirror.** This page mirrors [`docs/deprecation-calendar.md`](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/deprecation-calendar.md), the canonical source of truth. Do not edit this file directly; edit `docs/deprecation-calendar.md` and re-run `scripts/wiki/sync_mirrors.py`.
...
> **Cross-references**: [api-stability.md](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md)
> (deprecation policy section), [CHANGELOG.md](https://github.com/Polycentric-Labs/evidentia/blob/main/CHANGELOG.md)
...
Per the [api-stability.md](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md) deprecation policy:
...
2. Update [api-stability.md](https://github.com/Polycentric-Labs/evidentia/blob/main/docs/api-stability.md) if the surface is
