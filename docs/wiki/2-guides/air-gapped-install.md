...
```bash
docker pull ghcr.io/polycentric-labs/evidentia:v0.10.13
docker save ghcr.io/polycentric-labs/evidentia:v0.10.13 -o evidentia.tar
```
...
evidentia version
# → Evidentia v0.10.13 / Python 3.12.x
```
