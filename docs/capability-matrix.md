...
| FS-2 | CSP compliance engineer | Generate OSCAL POA&M from gap analysis | `evidentia gap-analyze --framework nist-800-53-rev5`, `evidentia poam create --from-gap-report`, `gap_report_to_oscal_poam()` | OSCAL 1.2.1 plan-of-action-and-milestones JSON with SHA-256 back-matter integrity; CRITICAL + HIGH findings materialized |
