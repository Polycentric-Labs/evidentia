...
|---------|--------|--------|
| **`0.10.11`** | ✅ **Supported** | Latest patch. See the [CHANGELOG](CHANGELOG.md) and the latest `docs/security-review-*.md` for what shipped and the CVE posture at this release. |
