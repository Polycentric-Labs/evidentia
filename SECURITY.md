...
|---------|--------|--------|
| **`0.11.1`** | ✅ **Supported** | Latest patch. See the [CHANGELOG](CHANGELOG.md) and the latest `docs/releases/reviews/security-review-*.md` for what shipped and the CVE posture at this release. |
...
pypi-attestations verify pypi \
  ...
  "pypi:evidentia-0.11.1-py3-none-any.whl"
```
