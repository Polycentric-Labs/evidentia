...
/** Due-diligence questionnaire as generated by the API. */
export type Questionnaire = components["schemas"]["Questionnaire"];
/** Completed-questionnaire ingest body ({responses, format?, …}). */
export type CompletedQuestionnaireIngest =
  components["schemas"]["CompletedQuestionnaireIngest"];
...
const realApi = {
  ...
  ddQuestionnaireIngest: (
    vendorId: string,
    payload: CompletedQuestionnaireIngest,
  ) =>
    request<Vendor>(
